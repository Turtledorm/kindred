...
\begin{itemise}
    ...
    \itemm{Classe} Grupo à qual uma \emph{unidade} pertence. Afeta o \emph{HP}, \emph{mov},
        \emph{atq}, \emph{def}, \emph{agi} e limita as \emph{armas} usadas pela \emph{unidade}.
    ...
    \itemm{Atq} Representação numérica do dano que uma \emph{unidade} pode
        causar.
    \itemm{Def} Representação numérica da redução do dano sofrido por uma
        \emph{unidade}.
    ...
    \itemm{Mov} Representa o número de \emph{tiles} que uma \emph{unidade} pode se
        deslocar a cada \emph{turno}, horizontalmente e verticalmente.
    \itemm{Range} Alcance do ataque de uma \emph{unidade}. Uma \emph{unidade} pode atacar
