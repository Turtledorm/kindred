...
\begin{itemise}
    ...
    \itemm{Agi} Representação numérica da agilidade de uma \emph{unidade}. Afeta a
        chance de desviar de um ataque.
    \itemm{Mov} Representa o número de \emph{tiles} de que uma \emph{unidade} pode se
    ...
    \itemm{Arma} Arma que uma unidade pode equipar. Cada tipo de arma tem seu alcance.
        Afeta o \emph{att} da \emph{unidade} de acordo com a distância do ataque.
