...
public class Game {
    ...
    /*
     * Initializes a Game.
     * - 'nameA' and 'nameB' are first and second Player's names.
     * - 'terrainFile' contains valid Terrains for the Map.
     * - 'mapFile' contains the Map itself.
     */
    public Game(String nameA, String nameB, String terrainFile, String mapFile) {
        try {
			map = MapFileParser.parseFile(mapFile, TerrainFileParser.parseFile(terrainFile));
    ...
    public void run() {
        ...
        while (playerAUnits > 0 && playerBUnits > 0) {
            ...
            String action = current.readCommand();
            // TODO: Parse action!
